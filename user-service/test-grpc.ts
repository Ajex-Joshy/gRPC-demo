...
import { UserProtoGrpcType } from "./src/interfaces/grpc/types/user.grpc.types";

const protoPath = path.resolve(__dirname, "../proto/user.proto");
const packageDef = protoLoader.loadSync(protoPath);
const proto = grpc.loadPackageDefinition(packageDef) as unknown as UserProtoGrpcType;
